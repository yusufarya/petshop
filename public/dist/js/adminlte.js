...
(function (global, factory) {
    ...
    var ControlSidebar = /*#__PURE__*/ (function () {
        ...
        _proto._fixScrollHeight = function _fixScrollHeight() {
            ...
            var navbarFixed =
                this._isNavbarFixed() &&
                $__default["default"](SELECTOR_HEADER$1).css("position") ===
                    "fixed";
            var footerFixed =
                this._isFooterFixed() &&
                $__default["default"](SELECTOR_FOOTER$1).css("position") ===
                    "fixed";
        ...
        _proto._fixHeight = function _fixHeight() {
            ...
            if (
                typeof $__default["default"].fn.overlayScrollbars !==
                "undefined"
            ) {
    ...
    var Dropdown = /*#__PURE__*/ (function () {
        ...
        _proto.fixPosition = function fixPosition() {
            ...
            var visiblePart =
                $__default["default"](window).width() - offset.left;
    ...
    var SELECTOR_DATA_TOGGLE_SCROLL_RIGHT =
    ...
    var SELECTOR_SIDEBAR_SEARCH_ITEM =
    ...
    var IFrame = /*#__PURE__*/ (function () {
        ...
        _proto.createTab = function createTab(
            title,
            link,
            uniqueName,
            autoOpen
            ...
            if (autoOpen) {
                if (this._config.loadingScreen) {
                    var $loadingScreen =
                        $__default["default"](SELECTOR_TAB_LOADING);
                        ...
                        $__default["default"](tabId + " iframe")
                            ...
                            .ready(function () {
                                if (_this2._config.loadingScreen) {
                                    if (
                                        typeof _this2._config.loadingScreen ===
                                        "number"
                                    ) {
                                        setTimeout(function () {
                                            $loadingScreen.fadeOut();
    ...
    var Layout = /*#__PURE__*/ (function () {
        ...
        _proto._isFooterFixed = function _isFooterFixed() {
            return (
                $__default["default"](SELECTOR_FOOTER).css("position") ===
                "fixed"
            );
        }; // Static
    ...
    var PushMenu = /*#__PURE__*/ (function () {
        ...
        _proto.expand = function expand() {
            ...
            if (
                ...
                $__default["default"](window).width() <=
                    this._options.autoCollapseSize
            ) {
    ...
    var SidebarSearch = /*#__PURE__*/ (function () {
        ...
        _proto._renderItem = function _renderItem(name, link, path) {
            ...
            groupItemElement
                .append(searchTitleElement)
                .append(searchPathElement);
