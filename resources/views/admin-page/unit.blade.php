    ...
    <div class="container-fluid">
        <div class="row mx-2">
          <div class="row justify-content-end mb-2 w-100">
            <button onclick="add_m_unit()" class="btn float-right btn-add "><i class="fas fa-plus-square"></i> &nbsp; Data</button>
          </div>
                ...
                @foreach ($resultData as $row)
                  <tr>
                      ...
                      <td style=" text-align: center;">
                        <a href="#" onclick="edit_m_unit(`{{$row->id}}`, `{{$row->initial}}`, `{{$row->name}}`)" class="text-warning"><i class="fas fa-edit"></i></a>
                        &nbsp;
                        <a href="#" onclick="delete_m_unit(`{{$row->id}}`, `{{$row->name}}`)" class="text-danger"><i class="fas fa-trash-alt"></i></i></a> 
                      </td>
                  </tr>
                @endforeach
              </tbody>
