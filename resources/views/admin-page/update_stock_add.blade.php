                ...
                <form action="/update-stock" method="POST">
                    ...
                    <div class="row my-4 mx-3">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 mt-2">
                            ...
                            <select class="form-control @error('product_id')is-invalid @enderror" name="product_id" id="product_id">
                                ...
                                @foreach ($products as $val)
                                    <option value="{{$val->id}}" {{ old('product_id') == $val->id ? 'selected' : '' }} >
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 mt-2">
                            ...
                            <input type="text" name="qty" id="qty" class="form-control" style="text-align: right;" placeholder="0" onkeyup="onlyNumbers(this)" maxlength="4">
                            @error('qty')
                            <small class="invalid-feedback">
                                Quantity {{ $message }}
                            </small>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-7 mt-2">
                            ...
                            <input type="text" name="price" id="price" class="form-control" style="text-align: right;" placeholder="0" onkeyup="formatRupiah(this, this.value)">
                            @error('price')
                            <small class="invalid-feedback">
                                Harga {{ $message }}
                            </small>
