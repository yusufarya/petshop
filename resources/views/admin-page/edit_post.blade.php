                ...
                <div class="row mx-2">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mt-2">
                        ...
                        <div class="card img-bordered ml-5 p-2">
                            @if ($post->image)
                                <img id="blah" src="{{ asset('/storage').'/'.$post->image }}" alt="preview" style="height: 250px;"/>
                            @else
                ...
                <div class="row justify-content-end mx-3">
                    <section class="col-lg-4">
                        <section style="float: right;">
                            <a href="/post" class="btn btn-outline-secondary mr-2"><i class="fas fa-backspace"></i> Batal</a>
