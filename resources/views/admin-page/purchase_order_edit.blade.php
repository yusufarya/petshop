            ...
            <div class="card mx-1 elevation-1 p-3 w-100">
                ...
                <div class="row my-4 mx-3">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="text" class="form-control" name="codeTrans" id="codeTrans" placeholder="{{ $resultData->code }}" readonly>
                        <input type="hidden" id="purchase_order_code" value="{{ $resultData->code }}">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        <label for="vendor_code">Vendor</label>
                        <select class="form-control" name="vendor_code" id="vendor_code" disabled>
                            <option value="">Pilih Vendor</option>
                            @foreach ($vendor as $val)
                                <option value="{{$val->code}}" {{ $resultData->vendor_code == $val->code ? 'selected' : '' }}>
                                    » &nbsp; {{ $val->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 mt-2">
                        ...
                        <input type="date" name="date" id="date" class="form-control" value="{{ date('Y-m-d', strtotime($resultData->date)) }}" disabled>
                    </div>
